 ...
 * @api
 */
class CGX_AdvancedView_DetailView2 extends CGX_AdvancedView_EditView
{
     ...
     */
    function setup( $module, $focus = null, $metadataFile = null, $tpl = 'include/DetailView/DetailView.tpl', $createFocus = true )
    {
        global $sugar_config;

        $this->th = new CGX_AdvancedView_TemplateHandler();
        $this->th->ss = $this->ss;
