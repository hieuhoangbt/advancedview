...
class ParserFactory {
        ...
        switch ($lView) {
            ...
            case MB_LISTVIEW :
                if ($subpanelName == null) {
                    ...
                    require_once 'modules/CGX_AdvancedView/parsers/views/SubpanelMetaDataParser.php';
                    return new SubpanelMetaDataParser($subpanelName, $moduleName, $packageName);
                }
            case MB_DASHLET :
            case MB_DASHLETSEARCH :
                require_once 'modules/CGX_AdvancedView/parsers/views/DashletMetaDataParser.php';
            ...
            case MB_VISIBILITY :
                require_once 'modules/CGX_AdvancedView/parsers/parser.visibility.php';
    ...
    protected static function checkForParserClass($view, $moduleName, $packageName, $nameOverride = false) {
        ...
        $fileNames = array(
            ...
            "custom/modules/CGX_AdvancedView/parsers/parser." . strtolower($prefix . $view) . ".php",
            "modules/CGX_AdvancedView/parsers/parser." . strtolower($prefix . $view) . ".php",
        );
    ...
    protected static function checkForStudioParserOverride($view, $moduleName, $packageName) {
        ...
        foreach ($sm->sources as $file => $def) {
            if (!empty($def['view']) && $def['view'] == strtolower($view) && !empty($def['parser'])) {
                $pName = $def['parser'];
                $path = "modules/CGX_AdvancedView/parsers/views/{$pName}.php";
