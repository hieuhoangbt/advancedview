 ...
 */
class CGX_AdvancedViewAbstractRelationships
{
    ...
    static function findRelatableModules ($includeActivitiesSubmodules = true)
    {
        ...
        $browser = new CGX_AdvancedViewStudioBrowser() ;
    ...
    function addFromPost ()
    {
        ...
        require_once 'modules/CGX_AdvancedView/parsers/relationships/CGX_AdvancedViewAbstractRelationship.php' ;
        foreach ( CGX_AdvancedViewAbstractRelationship::$definitionKeys as $key )
        {
        ...
        $newRelationship = CGX_AdvancedViewRelationshipFactory::newRelationship ( $definition ) ;
    ...
    protected function _load ($basepath)
    {
        ...
        if (file_exists ( $basepath . '/relationships.php' ))
        {
            ...
            foreach ( $relationships as $name => $definition )
            {
                ...
                $relationship = CGX_AdvancedViewRelationshipFactory::newRelationship ( $definition ) ;
