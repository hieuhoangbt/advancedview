...
class SubpanelMetaDataParser extends ListLayoutMetaDataParser
{
    ...
    function __construct ($subpanelName , $moduleName , $packageName = '')
    {
        ...
        {
            require_once 'modules/CGX_AdvancedView/parsers/views/DeployedSubpanelImplementation.php' ;
        ...
        {
            require_once 'modules/CGX_AdvancedView/parsers/views/UndeployedSubpanelImplementation.php' ;
