...
require_once 'modules/CGX_AdvancedView/parsers/views/AbstractMetaDataParser.php';
require_once 'modules/CGX_AdvancedView/parsers/views/MetaDataParserInterface.php';
...
class GridLayoutMetaDataParser extends AbstractMetaDataParser implements MetaDataParserInterface
{
    ...
    function __construct($view, $moduleName, $packageName = '')
    {
        ...
        if (empty($packageName)) {
            require_once 'modules/CGX_AdvancedView/parsers/views/DeployedMetaDataImplementation.php';
            $this->implementation = new DeployedMetaDataImplementation($view, $moduleName, self::$variableMap);
        } else {
            require_once 'modules/CGX_AdvancedView/parsers/views/UndeployedMetaDataImplementation.php';
    ...
    function getTabDefs()
    {
        ...
        foreach ($this->_viewdefs ['panels'] as $panelID => $panel) {
            ...
            if (isset($this->_viewdefs ['templateMeta'] ['tabDefs'] [strtoupper($panelID)] ['newTab']) && is_bool($this->_viewdefs ['templateMeta'] ['tabDefs'] [strtoupper($panelID)] ['newTab'])) {
            ...
            // collapsed panels
            if (isset($this->_viewdefs ['templateMeta'] ['tabDefs'] [strtoupper($panelID)] ['panelDefault']) && $this->_viewdefs ['templateMeta'] ['tabDefs'] [strtoupper($panelID)] ['panelDefault'] == 'collapsed') {
