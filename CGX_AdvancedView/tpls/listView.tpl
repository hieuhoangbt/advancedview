...
<link rel="stylesheet" type="text/css" href="modules/CGX_AdvancedView/tpls/ListEditor.css"/>
        ...
        <tr>
            ...
            <td align="right" class="editIcon">
				...
				onclick="var value_label = document.getElementById('subslot{$modCounter}label').innerHTML.replace(/^\s+|\s+$/g,''); 
					...
					{/if}
					ModuleBuilder.getContent('module=CGX_AdvancedView&action=editProperty&view_module={$view_module|escape:'url'}'+
