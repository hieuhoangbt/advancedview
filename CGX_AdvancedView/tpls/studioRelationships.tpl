...
{/if}
<div id='relGrid'></div>
{if $studio}{sugar_translate label='LBL_CUSTOM_RELATIONSHIPS' module='CGX_AdvancedView'}</h3>{/if}
<script>
{literal}
...
var grid = new YAHOO.widget.ScrollingDataTable('relGrid',
	[
	    {ldelim}key:'name',       label: SUGAR.language.get('CGX_AdvancedView','LBL_REL_NAME'),        width: 200, sortable: true{rdelim},
	    {ldelim}key:'lhs_module', label: SUGAR.language.get('CGX_AdvancedView','LBL_LHS_MODULE'),      width: 120, sortable: true{rdelim},
	    {ldelim}key:'relationship_type', label: SUGAR.language.get('CGX_AdvancedView','LBL_REL_TYPE'), width: 120, sortable: true{rdelim},
	    {ldelim}key:'rhs_module', label: SUGAR.language.get('CGX_AdvancedView','LBL_RHS_MODULE'),      width: 120, sortable: true{rdelim}
	],{literal}
    ...
    {MSG_EMPTY: SUGAR.language.get('CGX_AdvancedView','LBL_NO_RELS'), height:"auto"}
);
