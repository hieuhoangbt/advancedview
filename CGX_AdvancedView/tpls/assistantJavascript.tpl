...
{if $assistant.key && $assistant.group}
	{literal}Assistant.mbAssistant.setBody(SUGAR.language.get('CGX_AdvancedView','assistantHelp').{/literal}{$assistant.group}{literal}.{/literal}{$assistant.key}{literal});{/literal}
{/if}
{literal}
