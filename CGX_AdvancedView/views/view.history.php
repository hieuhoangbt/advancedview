...
require_once ('modules/CGX_AdvancedView/parsers/views/History.php');
...
class ViewHistory extends SugarView
{
    ...
    function browse()
    {
        ...
        $html = $smarty->fetch('modules/CGX_AdvancedView/tpls/history.tpl');
        echo $html;
    }
    ...
    function preview()
    {
        ...
        if ($this->layout == 'listview') {
            ...
            require_once ("modules/CGX_AdvancedView/views/view.searchview.php");
            $view = new ViewSearchView ( );
        } else if ($this->layout == 'dashlet' || $this->layout == 'dashletsearch') {
            require_once ("modules/CGX_AdvancedView/views/view.dashlet.php");
            $view = new ViewDashlet ( );
        } else if ($this->layout == 'popuplist' || $this->layout == 'popupsearch') {
            require_once ("modules/CGX_AdvancedView/views/view.popupview.php");
            $view = new ViewPopupview ( );
        } else {
            require_once ("modules/CGX_AdvancedView/views/view.layoutview.php");
