    ...
    function display()
    {
        ...
        switch ($type) {
            ...
            default:
                ...
                require_once('modules/CGX_AdvancedView/Module/CGX_AdvancedViewMainTree.php');
                $mbt = new CGX_AdvancedViewMainTree();
        }
        $smarty->assign('TEST_STUDIO', displayStudioForCurrentUser());
        $smarty->assign('ADMIN', is_admin($current_user));
        $smarty->display('modules/CGX_AdvancedView/tpls/includes.tpl');
        if ($mbt) {
        ...
        $smarty->display('modules/CGX_AdvancedView/tpls/index.tpl');
    }
