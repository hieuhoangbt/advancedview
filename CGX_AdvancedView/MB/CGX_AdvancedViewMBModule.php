...
require_once ('modules/CGX_AdvancedView/MB/CGX_AdvancedViewMBVardefs.php') ;
require_once ('modules/CGX_AdvancedView/MB/CGX_AdvancedViewMBLanguage.php') ;

class CGX_AdvancedViewMBModule
{
    public $name = '' ;
    public $config = array (
    ...
    function __construct ($name , $path , $package , $package_key)
    {
        ...
        $this->name = CGX_AdvancedViewMBModule::getDBName ( $name ) ;
        ...
        $this->mbvardefs = new CGX_AdvancedViewMBVardefs ( $this->name, $this->path, $this->key_name ) ;
    ...
    function saveConfig ()
    {
        $header = file_get_contents ( 'modules/CGX_AdvancedView/MB/header.php' ) ;
    ...
    function createClasses ($path)
    {
        ...
        fwrite ( $fp, $smarty->fetch ( 'modules/CGX_AdvancedView/tpls/MBModule/Class.tpl' ) ) ;
        fclose ( $fp ) ;
        //write vardefs
        $fp = sugar_fopen ( $path . '/vardefs.php', 'w' ) ;
        fwrite ( $fp, $smarty->fetch ( 'modules/CGX_AdvancedView/tpls/MBModule/vardef.tpl' ) ) ;
        fclose ( $fp ) ;

        if (! file_exists ( $path . '/' . $class [ 'name' ] . '.php' ))
        {
            $fp = sugar_fopen ( $path . '/' . $class [ 'name' ] . '.php', 'w' ) ;
            fwrite ( $fp, $smarty->fetch ( 'modules/CGX_AdvancedView/tpls/MBModule/DeveloperClass.tpl' ) ) ;
            fclose ( $fp ) ;
        }
        ...
        if (! empty ( $this->config [ 'studio' ] ))
        {
            ...
            fwrite ( $fp, $smarty->fetch ( 'modules/CGX_AdvancedView/tpls/MBModule/Studio.tpl' ) ) ;
            fclose ( $fp ) ;
        } else
        {
    ...
    function createMenu ($path)
    {
        ...
        fwrite ( $fp, $smarty->fetch ( 'modules/CGX_AdvancedView/tpls/MBModule/Menu.tpl' ) ) ;
        fclose ( $fp ) ;
    }
    ...
    function getNodes ()
    {
        ...
        foreach ( $psubs as $sub )
        {
            ...
            $lSubs [] = array ( 'name' => $subLabel , 'type' => 'list' , 'action' => 'module=CGX_AdvancedView&MB=true&action=editLayout&view=ListView&view_module=' . $this->name . '&view_package=' . $this->package . '&subpanel=' . $sub . '&subpanelLabel=' . $subLabel . '&local=1' ) ;
        }

        $searchSubs = array ( ) ;
        $searchSubs [] = array ( 'name' => translate('LBL_BASIC_SEARCH') , 'type' => 'list' , 'action' => "module=CGX_AdvancedView&MB=true&action=editLayout&view=basic_search&view_module={$this->name}&view_package={$this->package}"  ) ;
        $searchSubs [] = array ( 'name' => translate('LBL_ADVANCED_SEARCH') , 'type' => 'list' , 'action' => 'module=CGX_AdvancedView&MB=true&action=editLayout&view=advanced_search&view_module=' . $this->name . '&view_package=' . $this->package  ) ;
        $dashlets = array( );
        $dashlets [] = array('name' => translate('LBL_DASHLETLISTVIEW') , 'type' => 'dashlet' , 'action' => 'module=CGX_AdvancedView&MB=true&action=editLayout&view=dashlet&view_module=' . $this->name . '&view_package=' . $this->package );
		$dashlets [] = array('name' => translate('LBL_DASHLETSEARCHVIEW') , 'type' => 'dashletsearch' , 'action' => 'module=CGX_AdvancedView&MB=true&action=editLayout&view=dashletsearch&view_module=' . $this->name . '&view_package=' . $this->package );

		$popups = array( );
        $popups [] = array('name' => translate('LBL_POPUPLISTVIEW') , 'type' => 'popuplistview' , 'action' => 'module=CGX_AdvancedView&action=editLayout&view=popuplist&view_module=' . $this->name . '&view_package=' . $this->package );
		$popups [] = array('name' => translate('LBL_POPUPSEARCH') , 'type' => 'popupsearch' , 'action' => 'module=CGX_AdvancedView&action=editLayout&view=popupsearch&view_module=' . $this->name . '&view_package=' . $this->package );
		
        $layouts = array (
        	array ( 'name' => translate('LBL_EDITVIEW') , 'type' => 'edit' , 'action' => 'module=CGX_AdvancedView&MB=true&action=editLayout&view='.MB_EDITVIEW.'&view_module=' . $this->name . '&view_package=' . $this->package ) ,
        	array ( 'name' => translate('LBL_DETAILVIEW') , 'type' => 'detail' , 'action' => 'module=CGX_AdvancedView&MB=true&action=editLayout&view='.MB_DETAILVIEW.'&view_module=' . $this->name . '&view_package=' . $this->package ) ,
        	array ( 'name' => translate('LBL_LISTVIEW') , 'type' => 'list' , 'action' => 'module=CGX_AdvancedView&MB=true&action=editLayout&view='.MB_LISTVIEW.'&view_module=' . $this->name . '&view_package=' . $this->package ) ,
        	array ( 'name' => translate('LBL_QUICKCREATE') , 'type' => MB_QUICKCREATE,  'action' => 'module=CGX_AdvancedView&MB=true&action=editLayout&view='.MB_QUICKCREATE.'&view_module=' . $this->name . '&view_package=' . $this->package ) ,
        	array ( 'name' => translate('LBL_DASHLET') , 'type' => 'Folder', 'children' => $dashlets, 'action' => 'module=CGX_AdvancedView&MB=true&action=wizard&view=dashlet&view_module=' . $this->name . '&view_package=' . $this->package  ),
        	array ( 'name' => translate('LBL_POPUP') , 'type' => 'Folder', 'children' => $popups, 'action' => 'module=CGX_AdvancedView&MB=true&action=wizard&view=popup&view_module=' . $this->name . '&view_package=' . $this->package  ),
        	array ( 'name' => translate('LBL_SEARCH_FORMS') , 'action' => 'module=CGX_AdvancedView&MB=true&action=wizard&view=search&view_module=' . $this->name . '&view_package=' . $this->package , 'type' => 'folder' , 'children' => $searchSubs )
        	) ;

        $children = array (
        	array ( 'name' => translate('LBL_FIELDS') , 'action' => 'module=CGX_AdvancedView&action=modulefields&view_module=' . $this->name . '&view_package=' . $this->package ) ,
        	array ( 'name' => translate('LBL_LABELS') , 'action' => 'module=CGX_AdvancedView&action=modulelabels&view_module=' . $this->name . '&view_package=' . $this->package ) ,
        	array ( 'name' => translate('LBL_RELATIONSHIPS') , 'action' => 'module=CGX_AdvancedView&action=relationships&view_module=' . $this->name . '&view_package=' . $this->package ) ,
        	array ( 'name' => translate('LBL_LAYOUTS') , 'type' => 'Folder' , 'action' => "module=CGX_AdvancedView&action=wizard&view_module={$this->name}&view_package={$this->package}&MB=1" , 'children' => $layouts ) ,
        	) ;
        ...
        $nodes = array ( 'name' => $this->name , 'children' => $children , 'action' => 'module=CGX_AdvancedView&action=module&view_module=' . $this->name . '&view_package=' . $this->package ) ;
    ...
    function getProvidedSubpanels ()
    {
        ...
        {
            $f = dir ( $subpanelDir ) ;
            require_once 'modules/CGX_AdvancedView/parsers/relationships/AbstractRelationships.php' ;
