...
class CGX_AdvancedViewMBLanguage
{
     ...
     */
    function CGX_AdvancedViewMBLanguage($name, $path, $label, $key_name)
    {
    ...
    function save($key_name, $duplicate = false, $rename = false)
    {
        ...
        foreach ($this->strings as $lang => $values) {
            ...
            $mod_strings = return_module_language(str_replace('.lang.php', '', $lang), 'CGX_AdvancedView');
            $required = array(
