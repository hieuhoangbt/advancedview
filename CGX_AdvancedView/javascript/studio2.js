...
Studio2 = {
    ...
    newField: function () { // TODO: use properties to set field contents
        ...
        newField.innerHTML = '<span>' + SUGAR.language.get('CGX_AdvancedView', 'LBL_FILLER') + '</span>' + // the displayed label
    ...
    newRow: function (titleRequired) {
        ...
        if (titleRequired) {
            ...
            child.appendChild(document.createTextNode(SUGAR.language.get('CGX_AdvancedView', 'LBL_NEW_ROW')));
    ...
    newPanel: function () {
        ...
        child.className = 'panel_name';
        child.appendChild(document.createTextNode(SUGAR.language.get('CGX_AdvancedView', 'LBL_NEW_PANEL')));
        ...
        var editString = 'module=CGX_AdvancedView&action=editProperty&view_module=' + editModule + '&view=' + view + '&id_label=le_panelname_' + newPanel.id + '&name_label=label_' + panelLabel + '&title_label=' + SUGAR.language.get('ModuleBuilder', 'LBL_LABEL_TITLE');
    ...
    establishLocation: function (element) {
        ...
        if (location == null) {
            alert(SUGAR.language.get('CGX_AdvancedView', 'LBL_BADLY_FORMED_DOCUMENT'));
            die();
        }
        return location;
    },
...
//										if (property.hasAttributes) {
    ...
    handlePublish: function () {
        ...
        saveForm.appendChild(inputGroupFolder);
        ModuleBuilder.submitForm('prepareForSave');
        ajaxStatus.flashStatus(SUGAR.language.get('CGX_AdvancedView', 'LBL_DEPLOYE_COMPLETE'), 5000);
    },
    ...
    checkRequiredFields: function () {
        ...
        if (missing.length > 0)
        {
            var msg = SUGAR.language.get("CGX_AdvancedView", "ERROR_REQUIRED_FIELDS");
    ...
    checkCalcFields: function (view, error) {
        ...
        if (cfs.length > 0)
        {
            var msg = SUGAR.language.get("CGX_AdvancedView", error) + "\n";
