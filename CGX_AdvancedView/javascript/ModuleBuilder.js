    ...
    function addChildNodes(parentNode, parentData) {
        ...
        for (i in nodes) {
            if (typeof (nodes[i]) == 'object') {
                ...
                if (parseInt(nodes[i].data.is_group) == 1) {
                    var weightBtn = '<span id="cstm_group_ins"><a class="cstm_up" href="javascript:void(0)" target="_self" title="increase weight" onclick="ModuleBuilder.inscrease(this);"><img border="0" src="themes/SuiteR/images/basic_search.gif"></a><a href="javascript:void(0)" class="cstm_down" target="_self" title="decrease weight" onclick="ModuleBuilder.descrease(this);"><img border="0" src="themes/SuiteR/images/advanced_search.gif"></a></span><a href="javascript:void(0)" onclick=\'ModuleBuilder.getContent("' + nodes[i].data.action + '")\' target="_self" >' + nodes[i].data.label + '</a> ';
                    var weiData = {
                        html: weightBtn
                    };
                    var node = new YAHOO.widget.HTMLNode(weiData, parentNode);
                    node.label = nodes[i].data.label;
                    node.group_folder = nodes[i].data.group_folder;
                } else {
...
//                //Setup the main layout
                ...
                tp.addTab(new YAHOO.widget.Tab({
                    label: SUGAR.language.get('CGX_AdvancedView', 'LBL_SECTION_MAIN'),
                    scroll: true,
                    content: "<div> </div>",
                    id: "center",
                    active: true
...
//                    //frame: true,
                    units: [//ModuleBuilder.tree, ModuleBuilder.tabPanel,
                        {
                            ...
                            id: 'help',
                            header: SUGAR.language.get('CGX_AdvancedView', 'LBL_SECTION_HELP'),
                            position: 'right',
                            body: 'mbhelp',
                            scroll: true,
                            width: 250,
                ...
                if (Ck.getSub("CGX_AdvancedView", "helpHidden") == "true") {
                    mp.getUnitByPosition('right').collapse();
                }
                if (Ck.getSub("CGX_AdvancedView", "treeHidden") == "true") {
                ...
                if (ModuleBuilder.mode == 'studio') {
                    ...
                    mp.getUnitByPosition('left').header.firstChild.innerHTML = SUGAR.language.get('CGX_AdvancedView', 'LBL_SECTION_MODULES');
                    mbContent = mbContent ? mbContent : 'module=CGX_AdvancedView&action=wizard';
                } else {
                    mp.getUnitByPosition('left').collapse(false);
                    mbContent = mbContent ? mbContent : 'module=CGX_AdvancedView&action=home'; 
...
//                //We need to add ID's to the collapse buttons for automated testing
            ...
            layoutValidation: {
                ...
                popup: function () {
                    ModuleBuilder.layoutValidation.popup_window = new YAHOO.widget.SimpleDialog("emptyLayout", {
                        ...
                        modal: true,
                        fixedcenter: true,
                        text: SUGAR.language.get('CGX_AdvancedView', 'ERROR_MINIMUM_FIELDS'),
                        bodyStyle: "padding:5px",
                        buttons: [{
                                text: SUGAR.language.get('CGX_AdvancedView', 'LBL_BTN_CLOSE'),
                                isDefault: true,
                                handler: function () {
            ...
            history: {
                ...
                browse: function (module, layout, subpanel) {
                    ...
                    ModuleBuilder.history.popup_window.setHeader(module_str + ' : ' + SUGAR.language.get('CGX_AdvancedView', 'LBL_' + layout.toUpperCase()) + SUGAR.language.get('ModuleBuilder', 'LBL_HISTORY_TITLE'));
                ...
                preview: function (module, layout, id, subpanel) {
                    ...
                    if (!prevPanel) {
                        ...
                        prevPanel = new YAHOO.SUGAR.ClosableTab({
                            ...
                            label: SUGAR.language.get("CGX_AdvancedView", "LBL_MB_PREVIEW"),
                            id: 'preview:' + id,
                            scroll: true,
                            cacheData: true,
                            active: true
                ...
                revert: function (module, layout, id, subpanel) {
                    ...
                    if (prevTab)
                        ModuleBuilder.tabPanel.removeTab(prevTab);
                ...
                onSaveClick: function () {
                    ...
                    if (!saveBtn) {
                        ...
                        if (mbButtons) {
                            ...
                            alert(SUGAR.language.get('CGX_AdvancedView', 'LBL_NO_SAVE_ACTION'));
                        }
                    }
                    if (saveBtn) {
                ...
                popup: function () {
                    if (false == YAHOO.lang.isObject(ModuleBuilder.state.popup_window) || ModuleBuilder.state.popup_window.id != 'confirmUnsaved') {
                        ModuleBuilder.state.popup_window = new YAHOO.widget.SimpleDialog("confirmUnsaved", {
                            ...
                            modal: true,
                            fixedcenter: true,
                            text: SUGAR.language.get('CGX_AdvancedView', 'LBL_CONFIRM_DONT_SAVE'),
                            bodyStyle: "padding:5px",
                            buttons: [{
                                    text: SUGAR.language.get('CGX_AdvancedView', 'LBL_BTN_DONT_SAVE'),
                                    handler: ModuleBuilder.state.onDontSaveClick
                                }, {
                                    text: SUGAR.language.get('CGX_AdvancedView', 'LBL_BTN_CANCEL'),
                                    isDefault: true,
                                    handler: function () {
                                        ModuleBuilder.state.popup_window.hide()
                                    }
                                }, {
                                    text: SUGAR.language.get('CGX_AdvancedView', 'LBL_BTN_SAVE_CHANGES'),
                                    handler: ModuleBuilder.state.onSaveClick
                                }]
                        });
                        ModuleBuilder.state.popup_window.setHeader(SUGAR.language.get('CGX_AdvancedView', 'LBL_CONFIRM_DONT_SAVE_TITLE'));
                    }
            ...
            updateContent: function (o) {
                ...
                try {
                    ...
                    YAHOO.SUGAR.MessageBox.show({
                        title: SUGAR.language.get('CGX_AdvancedView', 'ERROR_GENERIC_TITLE'),
                        msg: o.responseText,
                        width: 500
                    });
                    return false;
                ...
                for (var maj in ajaxResponse) {
                    ...
                    if (name == 'mbwest') { //refresh package_tree!
                        ...
                        if (!comp) {
                            if (ajaxResponse[maj].action == 'deactivate')
                                continue;
            ...
            cUpdateTree: function (jsonObj) {
                ...
                addChildNodes(root, jsonObj.west.tree_data);
                tree.maxAnim = 2;
                tree.render();
            },
            /**
             ...
             * @returns null
             */
            inscrease: function (that) {
                var tree = ModuleBuilder.tree;
                var parentTd = $(that).parents("td");
                var el = document.getElementById(parentTd.attr("id"));
                var curNode = tree.getNodeByElement(el);
                var prevNode = curNode.previousSibling;
                if (prevNode != null) {
                    tree.popNode(curNode);
                    curNode.insertBefore(prevNode);
                    prevNode.parent.refresh();
                    ModuleBuilder.sortUpdated(prevNode.parent);
                }
            },
            /**
             * descrease weight
            ...
            descrease: function (that) {
                ...
                if (nextNode != null) {
                    ...
                    nextNode.parent.refresh();
                    ModuleBuilder.sortUpdated(nextNode.parent);
                }
            },
            /**
             * sort update weight
             ...
             * @returns null
             */
            sortUpdated: function (parentNode) {
                if (parentNode.label == 'Layouts') {
                    var module_name = parentNode.parent.label;
                    var arrIdx = [];
                    for (var i in parentNode.children) {
                        if (typeof parentNode.children[i] == 'object') {
                            arrIdx.push(parentNode.children[i].group_folder);
                        }
                    }
                    var ajaxSettings = {
                        url: "index.php?module=CGX_AdvancedView&action=sortUpdate",
                        method: 'POST',
                        data: {
                    ...
                    $.ajax(ajaxSettings);
                    ajaxStatus.showStatus(SUGAR.language.get('CGX_AdvancedView', 'LBL_AJAX_SORTING'));
                    YAHOO.SUGAR.MessageBox.show({
                        title: SUGAR.language.get('CGX_AdvancedView', 'LBL_AJAX_SORTING'),
                        msg: SUGAR.language.get('CGX_AdvancedView', 'LBL_AJAX_SORTING_TITLE'),
                        width: 500,
                        close: false
                    });
                }
            ...
            submitForm: function (formname, successCall) {
                /*
                 * Add field group name before save
                 */
                var saveForm = document.forms[formname]
                var inputGroupFolder = document.createElement('input');
                inputGroupFolder.setAttribute('type', 'hidden');
                inputGroupFolder.setAttribute('name', 'group_name');
                inputGroupFolder.setAttribute('value', $('#group_name').val());
                saveForm.appendChild(inputGroupFolder);
                /*
                 * End Add field group name before save
                 */
                ...
                ajaxStatus.showStatus(SUGAR.language.get('CGX_AdvancedView', 'LBL_AJAX_LOADING'));
                YAHOO.SUGAR.MessageBox.show({
                    title: SUGAR.language.get('CGX_AdvancedView', 'LBL_AJAX_LOADING'),
                    msg: SUGAR.language.get('CGX_AdvancedView', 'LBL_AJAX_LOADING_TITLE'),
                    width: 500,
                    close: false
                });
                ...
                if (typeof (successCall) == 'undefined') {
                    onSuccess = function (o) {
                        YAHOO.SUGAR.MessageBox.hide();
                        YAHOO.SUGAR.MessageBox.show({
                            title: SUGAR.language.get('CGX_AdvancedView', 'LBL_AJAX_RESPONSE_TITLE'),
                            msg: SUGAR.language.get('CGX_AdvancedView', 'LBL_AJAX_RESPONSE_MESSAGE'),
                            width: 500,
                            close: true
                        });
                    ...
                    onFailure = function (o) {
                        ...
                        YAHOO.SUGAR.MessageBox.show({
                            title: SUGAR.language.get('CGX_AdvancedView', 'LBL_AJAX_RESPONSE_TITLE'),
                            msg: SUGAR.language.get('CGX_AdvancedView', 'LBL_AJAX_RESPONSE_FAILED_MESSAGE'),
                            width: 500,
                            close: true
                        });
                        ModuleBuilder.updateContent(o);
                    ...
                    if (
                            ...
                            // user came from studio/fields layout by ajax urls
                                    ((urlVars.module == 'CGX_AdvancedView' && urlVars.action == 'modulefields' && urlVars.view_package == 'studio') ||
                                            // user refresh the page or came from direct url
                                                    (urlVars.module == 'CGX_AdvancedView' && urlVars.action == 'modulefield' && urlVars.view_package == ''))
                                            ) {
                    ...
                    preloader: {
                        ...
                        on: function (title, message) {
                            ...
                            if (typeof title == 'undefined') {
                                title = SUGAR.language.get('CGX_AdvancedView', 'LBL_AJAX_LOADING_TITLE'); // In Progress..
                            }
                            if (typeof message == 'undefined') {
                                message = SUGAR.language.get('CGX_AdvancedView', 'LBL_AJAX_LOADING_MESSAGE'); // Please wait, loading..
                            }
                    ...
                    main: function (type) {
                        document.location.href = 'index.php?module=CGX_AdvancedView&action=index&type=' + type;
                    },
                    failed: function (o) {
                        if (!ModuleBuilder.state.hideFailedMesage) {
                            ajaxStatus.flashStatus(SUGAR.language.get('CGX_AdvancedView', 'LBL_AJAX_FAILED_DATA'), 2000);
                        }
                    },
                    //Wizard Functions
                    ...
                    helpSetup: function (group, def, panel) {
                        if (!ModuleBuilder.panelHelp)
                            ModuleBuilder.panelHelp = [];
                        ...
                        if (!ModuleBuilder.AllHelpLang)
                            ModuleBuilder.AllHelpLang = SUGAR.language.get('CGX_AdvancedView', 'help');
                    ...
                    handleSave: function (form, callBack) {
                         ...
                         *  Add field group name before save
                         */
                        var saveForm = document.forms[form]
                        var inputGroupFolder = document.createElement('input');
                        inputGroupFolder.setAttribute('type', 'hidden');
                        inputGroupFolder.setAttribute('name', 'group_name');
                        inputGroupFolder.setAttribute('value', $('#group_name').val());
                        saveForm.appendChild(inputGroupFolder);
                        /*
                         * End add fied group name before save
                         */
                        if (check_form(form)) {
                            ModuleBuilder.state.isDirty = false;
                    ...
                    treeRefresh: function (type) {
                        ModuleBuilder.getContent('module=CGX_AdvancedView&action=ViewTree&tree=' + type);
                    },
                    //MB Specific
                    addModule: function (MBpackage) {
                        ModuleBuilder.getContent('module=CGX_AdvancedView&action=module&view_package=' + MBpackage);
                    },
                    viewModule: function (MBpackage, module) {
                        ModuleBuilder.getContent('module=CGX_AdvancedView&action=module&view_package=' + MBpackage + '&view_module=' + module);
                    },
                    packageDelete: function (MBpackage) {
                        ajaxStatus.showStatus(SUGAR.language.get('CGX_AdvancedView', 'LBL_AJAX_DELETING'));
                        if (confirm(SUGAR.language.get('CGX_AdvancedView', 'LBL_JS_REMOVE_PACKAGE'))) {
                            ModuleBuilder.getContent('module=CGX_AdvancedView&action=DeletePackage&package=' + MBpackage);
                            var node = ModuleBuilder.tree.getNodeByProperty('id', 'package_tree/' + MBpackage);
                            if (node)
                                ModuleBuilder.tree.removeNode(node, true);
                        }
                    },
                    packagePublish: function (form) {
                        if (check_form(form)) {
                            ajaxStatus.showStatus(SUGAR.language.get('CGX_AdvancedView', 'LBL_AJAX_BUILDPROGRESS'));
                    ...
                    packageDeploy: function (form, deployed) {
                        var confirmed = true;
                        if (deployed) {
                            confirmed = confirm(SUGAR.language.get('CGX_AdvancedView', 'LBL_JS_DEPLOY_PACKAGE'));
                        }
                        if (confirmed && check_form(form)) {
                            ajaxStatus.showStatus(SUGAR.language.get('CGX_AdvancedView', 'LBL_AJAX_DEPLOYPROGRESS'));
                    ...
                    beginDeploy: function (p) {
                        ModuleBuilder.asyncRequest('module=CGX_AdvancedView&action=DeployPackage&package=' + p, ModuleBuilder.deployComplete);
                    },
                    deployComplete: function (o) {
                        ...
                        if (!resp.match(/^\s*(\s*(Table already exists : [\w_]*)(<br>)*\s*)*complete$/m))
                        {
                            ...
                            alert(SUGAR.language.get("CGX_AdvancedView", "LBL_DEPLOY_FAILED"));
                        }
                    ...
                    moduleDelete: function (MBpackage, module) {
                        ajaxStatus.showStatus(SUGAR.language.get('CGX_AdvancedView', 'LBL_AJAX_DELETING'));
                        if (confirm(SUGAR.language.get('CGX_AdvancedView', 'LBL_JS_REMOVE_MODULE'))) {
                            ModuleBuilder.getContent('module=CGX_AdvancedView&action=DeleteModule&package=' + MBpackage + '&view_module=' + module);
                    ...
                    moduleViewFields: function (o) {
                        ...
                        ModuleBuilder.getContent('module=CGX_AdvancedView&action=modulefields&view_package=' + ModuleBuilder.MBpackage +
                    ...
                    moduleLoadField: function (name, type) {
                        ...
                        ModuleBuilder.getContent('module=CGX_AdvancedView&action=modulefield&view_package=' + ModuleBuilder.MBpackage +
                    ...
                    moduleLoadLabels: function (type) {
                        ...
                        if (type == "studio") {
                            ModuleBuilder.getContent('module=CGX_AdvancedView&action=editLabels&view_module=' + ModuleBuilder.module);
                        } else
                        if (type == "mb") {
                            ModuleBuilder.getContent('module=CGX_AdvancedView&action=modulelabels&view_package=' + ModuleBuilder.MBpackage + '&view_module=' + ModuleBuilder.module + '&type=' + type);
                        }
                    },
                    moduleViewRelationships: function (o) {
                        ModuleBuilder.callLock = false;
                        ModuleBuilder.getContent('module=CGX_AdvancedView&action=relationships&view_package=' + ModuleBuilder.MBpackage + '&view_module=' + ModuleBuilder.module);
                    },
                    moduleLoadRelationship2: function (name, resetLabel, checkLanguage) {
                        ...
                        if (!panel) {
                            panel = new YAHOO.SUGAR.ClosableTab({
                                label: SUGAR.language.get("CGX_AdvancedView", "LBL_RELATIONSHIP_EDIT"),
                                id: 'relEditor',
                                scroll: true,
                                cacheData: true,
                                active: true
                    ...
                    moduleDropDown: function (name, field) {
                        ModuleBuilder.getContent('module=CGX_AdvancedView&action=dropdown&view_package=' + ModuleBuilder.MBpackage + '&view_module=' + ModuleBuilder.module + '&dropdown_name=' + name + '&field=' + field);
                    },
                    moduleViewLayouts: function (o) {
                        ModuleBuilder.callLock = false;
                        ModuleBuilder.getContent('module=CGX_AdvancedView&MB=1&action=wizard&view_package=' + ModuleBuilder.MBpackage + '&view_module=' + ModuleBuilder.module);
                    },
                    ...
                    autoSetLayout: function () {
                        ...
                        if (document.getElementById('toolbox'))
                            Studio2.resizeDivs();
                        if (document.getElementById('edittabs'))
                            resizeDDLists();
                    },
                    ...
                    dropdownChanged: function (value) {
                        ...
                        ModuleBuilder.asyncRequest(
                                'module=CGX_AdvancedView&action=get_app_list_string&key=' + value +
