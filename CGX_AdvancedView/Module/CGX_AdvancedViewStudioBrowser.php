...
class CGX_AdvancedViewStudioBrowser {
    ...
    function loadModules() {
        ...
        while ($e = $d->read()) {
            ...
            if (file_exists('modules/' . $e . '/metadata/studio.php') && isset($GLOBALS ['beanList'][$e]) && (in_array($e, $access) || $current_user->isAdmin())) { // installed modules must also exist in the beanList
                $this->modules[$e] = CGX_AdvancedViewStudioModuleFactory::getStudioModule($e);
            }
        }
    }
    ...
    function getNodes() {
        ...
        foreach ($this->modules as $module) {
            $current_node = $module->getNodes();
            $nodes[$module->name] = $current_node;
        }
